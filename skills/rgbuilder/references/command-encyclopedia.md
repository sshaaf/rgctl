...
Detailed reference for all rgBuilder commands with full JSON samples and field specifications.

Samples below are truncated where noted. Field names match live CLI / `docs/json-api.md`. Fixture: `rgbuilder-tests/ecommerce-java` unless noted **illustrative** (schema-faithful shape).
