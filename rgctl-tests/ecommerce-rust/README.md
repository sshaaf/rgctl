...
Axum + SQLx e-commerce API for rgctl test indexing.
...
See [summary report](../rgctl-reports/REPORT.md) · [language report](../rgctl-reports/languages/rust.md) · [HTML](../rgctl-reports/languages/rust.html) (2026-07-22).
...
Raw: [`../rgctl-reports/rust-summary.json`](../rgctl-reports/rust-summary.json)
