...
| Guide | Command |
|-------|---------|
| [Discovering and Indexing](https://shaaf.dev/rgBuilder/docs/guides/discovering-and-indexing/) | `discover` |
| [Graph Query Language](https://shaaf.dev/rgBuilder/docs/guides/graph-query-language/) | `gql` |
| [Blast Radius Analysis](https://shaaf.dev/rgBuilder/docs/guides/blast-radius-analysis/) | `blast-radius` |
| [Semantic Search](https://shaaf.dev/rgBuilder/docs/guides/semantic-search/) | `semantic` |
| [Graph Metrics](https://shaaf.dev/rgBuilder/docs/guides/graph-metrics/) | `metrics` |
| [Community Detection](https://shaaf.dev/rgBuilder/docs/guides/community-detection/) | `communities` |
| [Program Slicing](https://shaaf.dev/rgBuilder/docs/guides/program-slicing/) | `slice` |
| [Hybrid CPG](https://shaaf.dev/rgBuilder/docs/guides/hybrid-cpg/) | `cpg` |
| [Inspecting CFG, PDG, and Dominance](https://shaaf.dev/rgBuilder/docs/guides/inspecting-cfg-pdg-dominance/) | `inspect` |
| [Exporting Graphs](https://shaaf.dev/rgBuilder/docs/guides/exporting-graphs/) | `export` |
| [CI Policy Checks](https://shaaf.dev/rgBuilder/docs/guides/ci-policy-checks/) | `check` |
| [HTTP Server and Dashboard](https://shaaf.dev/rgBuilder/docs/guides/http-server-and-dashboard/) | `serve` |
| [Migration Planning](https://shaaf.dev/rgBuilder/docs/guides/migration-planning/) | `discover --export-migration-hints` |
| [Agent Skill](https://shaaf.dev/rgBuilder/docs/guides/agent-skill/) | `install --skill` |

Also: [User Guide](https://shaaf.dev/rgBuilder/docs/user-guide/) · [JSON API](https://shaaf.dev/rgBuilder/docs/json-api/) · [Docs hub](https://shaaf.dev/rgBuilder/docs/)

## Highlights

### Agent skill installer

`rgctl install --skill` copies the bundled `skills/rgbuilder/` tree (embedded in the binary at compile time) into the target repo:
...
[docs/contributor-checklist.md](https://shaaf.dev/rgBuilder/docs/contributor-checklist/) — language, feature, and CI-gate hub (fixes #62, PR #64).
...
| `-f json install` | `schema_version` 1 — see [JSON API § install](https://shaaf.dev/rgBuilder/docs/json-api/) |
...
See [Install](https://shaaf.dev/rgBuilder/install/) and [User Guide §1](https://shaaf.dev/rgBuilder/docs/user-guide/).
